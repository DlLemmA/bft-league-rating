    ...
    <div class="p-4 pb-3">
        ...
        <div class="flex items-center flex-1 min-w-0">
          ...
          <div class="flex-1 min-w-0">
            ...
            <div class="flex items-center text-sm text-gray-600 mt-1">
              ...
              <span class="mr-3">№{{ license.id }}</span>
              <UIcon name="i-heroicons-user" class="mr-1" size="14" />
              <span>{{ license.gender === 'Мужской' ? 'Мужчина' : 'Женщина' }}</span>
            </div>
          </div>
        </div>
      ...
      <div class="flex items-center justify-between text-sm">
        <div class="flex items-center space-x-4">
          <div v-if="license.club" class="flex items-center text-gray-600">
            <UIcon name="i-heroicons-building-office" class="mr-1" size="14" />
            <span class="truncate">{{ license.club }}</span>
          </div>
          <div v-if="license.ageGroup" class="flex items-center">
