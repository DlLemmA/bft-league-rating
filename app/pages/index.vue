  ...
  <div class="container mx-auto px-4 py-8">
    <div class="mb-8 text-center">
      ...
      <p class="text-gray-600">
        Официальные результаты и рейтинг Любительской Лиги триатлона Беларуси по годам
      </p>
    </div>
...
// Page metadata
useHead({
  title: 'Рейтинг Любительской Лиги триатлона',
  meta: [
    { name: 'description', content: 'Официальные результаты и рейтинг Любительской Лиги триатлона Беларуси по годам' },
  ],
})
